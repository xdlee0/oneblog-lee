...
!function () {
    function t(e) {
        var n = t.modules[e];
        if (!n) throw new Error('failed to req "' + e + '"');
    ...
    t.loader = "component", t.helper = {}, t.helper.semVerSort = function (t, e) {
        for (var n = t.version.split("."), i = e.version.split("."), o = 0; o < n.length; ++o) {
            var s = parseInt(n[o], 10), r = parseInt(i[o], 10);
            if (s !== r) return s > r ? 1 : -1;
            var c = n[o].substr(("" + s).length), a = i[o].substr(("" + r).length);
            if ("" === c && "" !== a) return 1;
            if ("" !== c && "" === a) return -1;
        ...
        var o = /(.*)~(.*)@v?(\d+\.\d+\.\d+[^\/]*)$/;
        /(.*)~(.*)/.test(e) || i(e);
        for (var s = Object.keys(t.modules), r = [], c = [], a = 0; a < s.length; a++) {
            var l = s[a];
            if (new RegExp(e + "@").test(l)) {
                var h = l.substr(e.length + 1);
                null != o.exec(l) ? r.push({version: h, name: l}) : c.push({version: h, name: l})
            }
        }
        if (0 === r.concat(c).length && i(e), r.length > 0) {
            u = r.sort(t.helper.semVerSort).pop().name;
            return !0 === n ? u : t(u)
        }
        ...
        var o = t("component~indexof@0.0.3"), s = /\s+/, r = Object.prototype.toString;
        n.exports = function (t) {
            ...
            var t = this.el.className.replace(/^\s+|\s+$/g, "").split(s);
        ...
        (t = e.exports = function (t, e) {
            ...
            if (!e.one) throw new Error(".one callback reqd");
            if (!e.all) throw new Error(".all callback reqd");
            return n = e.one, t.all = e.all, t
        }
    }), t.register("component~matches-selector@0.1.5", function (e, n) {
        var i = t("component~query@0.0.3"), o = Element.prototype,
        ...
        n.exports = function (t, e) {
            ...
            for (var n = i.all(e, t.parentNode), o = 0; o < n.length; ++o) if (n[o] == t) return !0;
            return !1
        }
        ...
        var i = t("component~closest@0.1.4"), o = t("component~event@0.1.4");
        ...
        var s = t("component~event@0.1.4"), r = t("component~delegate@0.2.3");
        n.exports = i, i.prototype.sub = function (t, e, n) {
            ...
            var i = o(t), c = this.el, a = this.obj, l = i.name, e = e || "on" + l, h = [].slice.call(arguments, 2);
        ...
        var o = t("abpetkov~transitionize@0.0.3"), s = t("ftlabs~fastclick@v0.6.11"), r = t("component~classes@1.2.1"),
        ...
        i.prototype.hide = function () {
            ...
            var e = this.isChecked(), n = this.switcher, i = this.jack;
            ...
            } : {border: this.options.speed, "box-shadow": this.options.speed}, o(this.switcher, t), o(this.jack, e)
